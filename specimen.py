...
class specimen:
    ...
    def format(self, readings):
        degree_symbol=u"\u00b0"
        return "#growlab - {}\nTempérature: {:05.2f}{}C \nHumidité: {:05.2f}% \nLuminosité: {} \nPression: {:05.2f}hPa".format(readings["time_tz_Paris"], readings["temperatureDHT22"], degree_symbol, readings["humidityDHT22"], readings["brightnessNano"], readings["pressureBMP280"])
